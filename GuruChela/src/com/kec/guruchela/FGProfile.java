...
public class FGProfile extends SherlockFragment {
	 public FGProfile() {
	...
	EditText username,institution,email,description;
	ImageButton share;
	String selectedfaculty,selectedsemester,finaluser;
	Dialog choose;
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup root = (ViewGroup) inflater.inflate(R.layout.x_f_gprofile,
				null);
		username = (EditText) root.findViewById(R.id.et_Gprofile_username);
		institution = (EditText) root.findViewById(R.id.et_Gprofile_institution);
		email = (EditText) root.findViewById(R.id.et_Gprofile_email);
		description = (EditText) root.findViewById(R.id.et_Gprofile_description);
		share = (ImageButton) root.findViewById(R.id.ib_Gprofile_share);
	...
	// Creating AsynTask for Insert into Database
			...
			private class SelectDB extends AsyncTask<String, String, String> {
				  ...
				  protected String doInBackground(String... params) {
				   ...
				   String url = "http://www.toolittletoobig.com/guruchela_php/select_GProfile_gc.php";
